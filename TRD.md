...
| V-003 | TR-005/006/008/017 | Serve artifacts and preview at root/prefix; inspect hierarchy, locale routes, directory indexes and assets. #89 owns the preview-mount fix | Broad program open; root-redirect follow-up passed six actual-application HTTP cases and 94 real-sample HTTP checks on Windows. Earlier results and failures retained; see PRD V-003 |
...
- **Review limitations:** Local engine-based acceptance is complete; no real-device matrix, full accessibility/security audit, benchmark or release is claimed.
