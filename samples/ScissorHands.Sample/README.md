...
This project provides an end-to-end preview of the engine using the built-in
`default` theme and local project references.
...
Generated preview and build outputs are written to `preview/` and `dist/`
respectively.
