...
The navigation groups pages using their slugs. Expand Parent to find [Child](parent/child) and the non-clickable Group label. Group has no page of its own; it appears because [Visible Grandchild](parent/group/visible-grandchild) is visible in navigation.
